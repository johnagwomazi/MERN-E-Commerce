      ...
      <div className="border-b border-slate-100 bg-slate-50/60 p-4 sm:p-6">
        <div className="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
          <div className="flex items-start gap-3">
            <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl bg-[#6d4df2]/10 text-[#6d4df2] sm:h-11 sm:w-11">
          ...
          <div className="rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 shadow-sm ring-1 ring-slate-100 sm:px-4 sm:py-2 sm:text-sm">
            ...
            {orders.map((order) => (
              <article key={order._id} className="overflow-hidden rounded-2xl border border-slate-100 bg-white transition-shadow hover:shadow-md">
                <button
                  ...
                  className="flex w-full flex-col gap-3 border-b border-slate-100 bg-slate-50/50 px-4 py-4 text-left transition-colors hover:bg-slate-50 sm:flex-row sm:items-center sm:justify-between sm:px-5"
                ...
                >
                  <div className="space-y-2 sm:space-y-2">
                    ...
                    <p className="text-xs font-medium uppercase tracking-[0.25em] text-[#6d4df2] sm:hidden">
                      View details
                    </p>
                  </div>
                ...
                {expandedOrderId === order._id ? (
                  <div className="px-4 py-4 sm:px-5">
                    <div className="rounded-2xl bg-slate-50 px-4 py-3 text-sm text-slate-600">
                      <p className="text-xs font-semibold uppercase tracking-[0.25em] text-slate-400">Delivery address</p>
                      <p className="mt-1 text-sm leading-relaxed text-slate-700">{order.deliveryAddress || 'No delivery address provided.'}</p>
                    </div>
                    ...
                    {order.items.map((item) => {
                      ...
                      return (
                        <div key={productKey} className="flex items-start justify-between gap-4 py-3 text-sm sm:items-center">
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8">
      <div className="sm:hidden">
        <div className="relative overflow-hidden rounded-3xl border border-white/15 bg-[#6d4df2] px-5 py-6 text-white shadow-[0_32px_96px_rgba(109,77,242,0.35)]">
          <div className="absolute -left-10 -top-10 h-44 w-44 rounded-full bg-white/15 blur-[70px] pointer-events-none" />
          <div className="absolute right-0 bottom-0 h-52 w-52 rounded-full bg-white/10 blur-[80px] pointer-events-none" />
          <div className="relative z-10 space-y-3">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/15 px-3 py-1 text-[11px] font-semibold text-white/90 backdrop-blur-md">
              <Package size={12} className="text-white/90" />
              Customer Workspace
            </span>
            <div>
              ...
              <p className="mt-2 text-sm leading-relaxed text-white/85">
                Track your recent purchases, monitor pending items, and review your order history at a glance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <div className="rounded-2xl border border-white/20 bg-[#6d4df2] p-4 text-white shadow-[0_16px_40px_rgba(109,77,242,0.22)]">
            <div className="flex items-center justify-between gap-2">
              <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-white/70">Total Orders</p>
              <Package size={15} className="text-white/90" />
            </div>
            <p className="mt-3 text-2xl font-extrabold leading-none">{orders.length}</p>
          </div>

          <div className="rounded-2xl border border-white/20 bg-[#6d4df2] p-4 text-white shadow-[0_16px_40px_rgba(109,77,242,0.22)]">
            <div className="flex items-center justify-between gap-2">
              <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-white/70">Pending Orders</p>
              <Clock size={15} className="text-white/90" />
            </div>
            <p className="mt-3 text-2xl font-extrabold leading-none">{pendingOrders.length}</p>
          </div>

          <div className="rounded-2xl border border-white/20 bg-[#6d4df2] p-4 text-white shadow-[0_16px_40px_rgba(109,77,242,0.22)]">
            <div className="flex items-center justify-between gap-2">
              <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-white/70">Delivered</p>
              <CheckCircle2 size={15} className="text-white/90" />
            </div>
            <p className="mt-3 text-2xl font-extrabold leading-none">{deliveredOrders.length}</p>
          </div>

          <div className="rounded-2xl border border-white/20 bg-[#6d4df2] p-4 text-white shadow-[0_16px_40px_rgba(109,77,242,0.22)]">
            <div className="flex items-center justify-between gap-2">
              <p className="text-[11px] font-bold uppercase tracking-[0.25em] text-white/70">Total Spend</p>
              <DollarSign size={15} className="text-white/90" />
            </div>
            <p className="mt-3 truncate text-[1.05rem] font-extrabold leading-tight" title={formatCurrency(totalSpend)}>
      ...
      <div className="relative hidden overflow-hidden rounded-3xl border border-white/15 bg-[#6d4df2] px-6 py-8 text-white shadow-[0_32px_96px_rgba(109,77,242,0.35)] sm:block sm:p-10">
        ...
        <div className="relative z-10 grid gap-8 lg:grid-cols-12 lg:items-center">
          <div className="lg:col-span-5 space-y-4">
            <span className="inline-flex items-center gap-1.5 rounded-full border border-white/20 bg-white/15 px-3 py-1 text-xs font-semibold text-white/90 backdrop-blur-md">
      ...
      <div className="sm:hidden">
        <div className="rounded-[2rem] border border-white/70 bg-white shadow-[0_24px_80px_rgba(9,17,31,0.08)]">
          <div className="flex items-center justify-between border-b border-slate-100 px-4 py-4">
            <div>
              <p className="text-[11px] uppercase tracking-[0.3em] text-ink/45">Order history</p>
              <h2 className="mt-1 text-xl font-black text-ink">Your recent purchases</h2>
            </div>
            <button
              type="button"
              onClick={loadOrders}
              disabled={loading}
              className="inline-flex h-11 w-11 items-center justify-center rounded-full bg-[#6d4df2] text-white shadow-md transition-colors hover:bg-[#5b3ee0] disabled:cursor-not-allowed disabled:opacity-60"
      ...
      <section className="hidden rounded-[2rem] border border-white/70 bg-white shadow-[0_24px_80px_rgba(9,17,31,0.08)] sm:block">
        <div className="flex flex-col gap-4 border-b border-slate-100 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
          ...
          <button
            ...
            onClick={loadOrders}
            disabled={loading}
            className="hidden items-center justify-center gap-2 rounded-full bg-[#6d4df2] px-5 py-3 text-sm font-semibold text-white shadow-md transition-colors hover:bg-[#5b3ee0] disabled:cursor-not-allowed disabled:opacity-60 sm:inline-flex"
          >
            <RefreshCw size={16} className={loading ? 'animate-spin' : ''} />
